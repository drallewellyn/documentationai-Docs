...
| Document | Purpose |
|---|---|
| [`redesign-report.md`](./redesign-report.md) | **The main sectioned report** — twelve design-domain sections (Competency Framework & Its Critics; Entrustable Professional Activities; Curriculum Design; Pedagogy; Assessment; Burden of Assessment; Feedback; Supervisors/Faculty Development; Professional Identity & Reflective Practice; Equity & Cultural Safety incl. First Nations; Program Evaluation; the Training-to-Practice Continuum), each with a narrative plus a reference table (reference · link · what it tells us · category). |
