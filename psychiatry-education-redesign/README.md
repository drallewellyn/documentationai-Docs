...
| Document | Purpose |
|---|---|
| [`redesign-report.md`](./redesign-report.md) | **The main sectioned report** — thirteen design-domain sections (Competency Framework & Its Critics; Entrustable Professional Activities; Curriculum Design; Pedagogy; Assessment; Burden of Assessment; Feedback; Supervisors/Faculty Development; Professional Identity & Reflective Practice; Equity & Cultural Safety incl. First Nations; Program Evaluation; the Training-to-Practice Continuum; Assessment Review Panels), each with a narrative plus a reference table (reference · link · what it tells us · category). |
